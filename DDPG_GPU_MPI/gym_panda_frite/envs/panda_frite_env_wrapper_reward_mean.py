...
class PandaFriteEnvWrapperRewardMean(Wrapper):
	
	def __init__(self, env):
		super().__init__(env)
		self.env = env
		print("$$$$$ CONSTRUCTOR PandaFriteEnvWrapperRewardMean $$$$$")
	...
	def step_bullet(self, action, rank=None, episode=None, step=None):
		...
		info = {
			'is_success': self.env.is_success(d),
			'distance_error' : d,
			'exploded' : exploded,
		...
		if (d > self.env.distance_threshold):
			done = False
			
		print("$$$$$ step_bullet PandaFriteEnvWrapperRewardMean $$$$$")
	...
	def step_ros(self, action, rank=None, episode=None, step=None):
		...
		print("$$$$$ step_ros PandaFriteEnvWrapperRewardMean $$$$$")
		print("obs={}".format(obs))
		print("reward={}, done={}, info={}".format(reward,done,info))
		print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
